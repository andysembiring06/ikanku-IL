...
import image6 from "../assets/klik_halaman_2/6.jpg";
import image7 from "../assets/klik_halaman_2/7.jpg";
import image8 from "../assets/klik_halaman_2/8.jpg";
      ...
      <div className="max-w-3xl mx-auto p-4 bg-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            <Link
              to="/Klik_halaman_1" // Ganti dengan rute yang sesuai
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            <Link
              to="/Klik_halaman_3" // Ganti dengan rute yang sesuai
              className="block relative overflow-hidden"
            >
              <img
                src={image7}
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            <Link
              to="/Klik_halaman_4" // Ganti dengan rute yang sesuai
              className="block relative overflow-hidden"
            >
              <img
                src={image8}
              ...
              />
              <h3 className="text-base font-medium text-gray-800 p-3">
                Ini 9 Manfaat Ikan Air Tawar untuk Kes....
              </h3>
            </Link>
            <span className="inline-block bg-white border border-gray-300 text-xs px-3 py-1 rounded-full text-gray-800 ml-3 mb-2">
              Bisnis
