...
import image6 from "../assets/klik_halaman_3/6.jpg";
import image7 from "../assets/klik_halaman_3/7.jpg";
import image8 from "../assets/klik_halaman_3/8.jpg";
      ...
      <div className="max-w-3xl mx-auto p-4 bg-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            <Link
              to="/Klik_halaman_2" // Ganti dengan rute yang sesuai
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            <Link
              ...
              to="/" // Ganti dengan rute yang sesuai
              className="block relative overflow-hidden"
            >
              <img
                src={image7}
