...
import image6 from "../assets/klik_halaman_12/6.jpg";
import image7 from "../assets/klik_halaman_12/7.jpg";
import image8 from "../assets/klik_halaman_12/8.jpg";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            ...
            >
              ...
              <h3 className="text-base font-medium text-gray-800 p-3">
                Ikan air tawar di dunia terancam p....
              </h3>
            </Link>
          ...
          <article className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative">
            ...
            >
              ...
              />
              <h3 className="text-base font-medium text-gray-800 p-3">
                Inilah 5 Fakta Mengenai Ikan Mu....
              </h3>
            </Link>
            <span className="inline-block bg-white border border-gray-300 text-xs px-3 py-1 rounded-full text-gray-800 ml-3 mb-2">
              Bisnis
            </span>
            <p className="text-xs text-gray-800 px-3 pb-3">18 Agustus 2024</p>
          </article>
